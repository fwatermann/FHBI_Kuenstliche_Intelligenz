...
public class NotEqualConstraint implements Constraint<Variable, Integer> {
    ...
    public boolean isSatisfiedWith(Assignment<Variable, Integer> assignment) {
        ...
        //System.out.printf("Not Equal Constraint\t %s(%s) != %s(%s) => %b%n", var1.toString(), assignment.getValue(var1), var2.toString(), assignment.getValue(var2), result);
        return result;
    }
}
